...
import tk.mallumo.utils.Shell.Command
import java.io.*
import java.util.*
...
class Shell @Throws(NotFoundException::class) @JvmOverloads constructor(
    ...
    private fun DataOutputStream.close() = try {
        close()
    } catch (ignored: IOException) {
    }
    ...
    object Command {
        ...
        data class Result(
             ...
             * @property startTime The timeâ€”in milliseconds since January 1, 1970, 00:00:00 GMTâ€”when
             *                     the command started execution.
             * @property endTime   The timeâ€”in milliseconds since January 1, 1970, 00:00:00 GMTâ€”when
